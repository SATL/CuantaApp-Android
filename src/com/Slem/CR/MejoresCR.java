...
public class MejoresCR extends ListActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String url = "http://www.cuantarazon.com/top/semana";
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		Intent i = new Intent();
		i.setClass(MejoresCR.this, onClick.class);
	...
	public void updateViewImagenes(List<Imagen> imagenes){
	  	MyAdapter adaptador = new MyAdapter( MejoresCR.this, imagenes );
