...
public class AleatorioCC extends ListActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		final String url = "http://www.cuantocabron.com/aleatorio";
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		Intent i = new Intent();
		i.setClass(AleatorioCC.this, onClick.class);
...
return true;  
	...
	public void updateViewImagenes(List<Imagen> imagenes){
	  	MyAdapter adaptador = new MyAdapter( AleatorioCC.this, imagenes );
