...
public class MejoresVF extends ListActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String url = "http://www.vistoenlasredes.com/top/semana";
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		Intent i = new Intent();
		i.setClass(MejoresVF.this, onClick.class);
	...
	public void updateViewImagenes(List<Imagen> imagenes){
	  	MyAdapter adaptador = new MyAdapter( MejoresVF.this, imagenes );
