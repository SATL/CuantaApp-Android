...
public class AleatorioVF extends ListActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		final String url = "http://www.vistoenlasredes.com/aleatorio";
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		Intent i = new Intent();
		i.setClass(AleatorioVF.this, onClick.class);
	...
	public void updateViewImagenes(List<Imagen> imagenes){
	  	MyAdapter adaptador = new MyAdapter( AleatorioVF.this, imagenes );
